    ...
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row gap-4 md:gap-10 w-full pt-5 md:pt-20 pb-10 border-0 border-b-1 border-[#dddddd] px-4 md:px-0">
        ...
        <div className="md:w-5/8">
          <h2 className="text-[#001931] font-bold text-[32px] text-center md:text-left">
            {title}
          </h2>
          <p className="text-[#627382] text-xl pb-5 pt-2 text-center md:text-left">
            Developed by{" "}
          ...
          <div>
            <div className="flex  justify-center items-center md:justify-between gap-7 py-5 border-0 border-t-1 border-[#dddddd] md:w-3/5">
              <div className="w-full flex flex-col md:justify-start  justify-center md:items-start items-center gap-3 md:gap-0">
                <img
                  ...
                  alt="Download icon"
                />
                <p className="text-[#001931] pt-3 text-base hidden md:block">
                  Downloads
                </p>
                <h3 className="text-[#001931] font-extrabold text-4xl md:text-[40px]">
                  {downloads}
                </h3>
              </div>
              <div className="w-full flex flex-col md:justify-start  justify-center md:items-start items-center gap-3 md:gap-0">
            ...
            <div className="text-center md:text-left">
              <button
                ...
                className={`bg-[#00D390] text-white rounded px-5 py-3 mt-5 md:mt-0 text-xl font-semibold ${
      ...
      <div className="py-10 border-0 border-b-1 border-[#dddddd] px-4 md:px-0">
        <h4 className="text-[#001931] font-semibold text-2xl text-center md:text-left pb-5">
          Ratings
        </h4>
        <ResponsiveContainer
          width="100%"
