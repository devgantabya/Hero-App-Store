...
const AllApps = () => {
    ...
    return (
        ...
        <div className='container mx-auto pb-15'>
            <h1 className='text-4xl md:text-5xl text-[#001931] font-bold text-center py-5 mt-20'>Our All Applications</h1>
            <p className='text-[#627382] text-xl text-center pb-10'>Explore All Apps on the Market developed by us. We code for Millions</p>
                ...
                <Suspense fallback={<span>Loading...</span>} hydrateFallback={<span>Loading initial data...</span>}>
                    {filteredApps.length > 0 ? (
                        <div className='grid grid-cols-1 md:grid-cols-4 gap-5'>
                            {
                                filteredApps.map((insideApps, index) => (<InsideAllApps insideApps={insideApps} key={index}></InsideAllApps>
